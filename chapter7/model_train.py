...
tokenizer.save_pretrained("./models/" + checkpoint + "/")
base_model = AutoModel.from_pretrained(checkpoint)
base_model.save_pretrained("./models/" + checkpoint + "/")
...
#         self.bert_encoder = AutoModel.from_pretrained("./models/" + checkpoint + "/")
...
# model = BertForPairwiseCLS().to(device_cuda)
# print(model)
...
model = BertForPairwiseCLS.from_pretrained(checkpoint, config=config).to(device_cuda)
print(model)
